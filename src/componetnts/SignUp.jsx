...
export default function Signup() {
  ...
  function handleSubmit(e) {
    ...
    // TODO: استبدل بده باستدعاء API التسجيل
    alert("Account created (demo).");
  }

  return (
    <main className="min-h-screen pt-24 bg-gradient-to-b from-[#0b0d1e] via-[#111432] to-[#1a1941]/85 text-indigo-100 flex flex-col justify-between">
      {/* overlay */}
      <div
        aria-hidden="true"
      ...
      <section className="relative w-full max-w-md mx-auto flex-1 flex items-center px-4">
        <div className="rounded-2xl border border-indigo-800/40 shadow-[0_20px_60px_rgba(79,70,229,0.25)]
                        bg-gradient-to-b from-[#0b0d1e] via-[#111432] to-[#1a1941]/85
